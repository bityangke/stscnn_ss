function info = stscnnTest(varargin)
...
if exist(opts.imdbPath)
    ...
    imdb = stscnnSetup_Test('dataDir', opts.dataDir, 'includeTest', false, ...
...
test = find(imdb.images.set == 3 & imdb.images.segmentation) ;
